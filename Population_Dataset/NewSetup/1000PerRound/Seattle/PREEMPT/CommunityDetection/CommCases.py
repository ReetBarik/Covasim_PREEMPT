...
fig.suptitle('Community Cases vs Size (PREEMPT)', fontsize=15)
...
fig.suptitle('Cases v Community size Discrepancy (PREEMPT)', fontsize=15)
fig.text(0.5, 0.03, 'Communities (total = 12)', ha='center')
...
fig.suptitle('Cases and seeds v Community size Discrepancy (PREEMPT)', fontsize=12)
fig.text(0.5, 0.03, 'Communities (total = 12)', ha='center')
